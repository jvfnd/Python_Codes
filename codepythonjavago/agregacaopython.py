...
endereco1 = Endereco("Av. Principal", "Cidade A", "Estado A", "12345-678")
pessoa1 = Pessoa("João", 20)
pessoa1.adicionar_endereco(endereco1)

endereco2 = Endereco("Av. Secundaria", "Cidade B", "Estado B", "98765-432")
pessoa2 = Pessoa("Maria", 23)
pessoa2.adicionar_endereco(endereco2)

empresa = Empresa("Empresa ABC", "123214235145")
